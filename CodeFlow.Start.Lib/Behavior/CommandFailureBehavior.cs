...
namespace CodeFlow.Start.Lib.Behavior;

public class CommandFailureBehavior<TRequest, TResponse>(ILogger<CommandFailureBehavior<TRequest, TResponse>> logger, BaseDbContext dbContext, IConfiguration config) : IPipelineBehavior<TRequest, TResponse>
